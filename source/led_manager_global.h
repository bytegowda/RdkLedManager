...
#ifndef _LEDMGR_GLOBAL_H_
#define _LEDMGR_GLOBAL_H_
...
#define ComponentCommonDmInit(component_com_ledmanager)                                          \
        {                                                                                             \
            AnscZeroMemory(component_com_ledmanager, sizeof(COMPONENT_COMMON_LED_MANAGER)); \
            component_com_ledmanager->Name        = NULL;                                        \
            component_com_ledmanager->Version     = 1;                                           \
            component_com_ledmanager->Author      = NULL;                                        \
            component_com_ledmanager->Health      = RDK_COMMON_COMPONENT_HEALTH_Red;            \
            component_com_ledmanager->State       = RDK_COMMON_COMPONENT_STATE_Running;         \
            if(g_iTraceLevel >= CCSP_TRACE_LEVEL_EMERGENCY)                                           \
                component_com_ledmanager->LogLevel = (ULONG) g_iTraceLevel;                      \
            component_com_ledmanager->LogEnable   = TRUE;                                        \
            component_com_ledmanager->MemMaxUsage = 0;                                           \
            component_com_ledmanager->MemMinUsage = 0;                                           \
            component_com_ledmanager->MemConsumed = 0;                                           \
        }


typedef  struct
_COMPONENT_COMMON_LED_MANAGER
{
    char*                           Name;
    ULONG                           Version;
    char*                           Author;
...
COMPONENT_COMMON_LED_MANAGER, *PCOMPONENT_COMMON_LED_MANAGER;
